                ...
                <div class="card">
                    ...
                    <form action="{{route('productimage.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Select Images <span style="color:red;">*</span></label>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="productimageDelete({{$item->id}})" style="color: #fff; cursor:pointer;" class="btn btn-danger"><span class="fa fa-trash-alt"></span> Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
...
<script>
    function productimageDelete(id) 
    {
        ...
        }).then((willDelete) => 
        {
            if (willDelete) 
            {
                var url = '{{ route("productimage.destroy", ":id") }}';
