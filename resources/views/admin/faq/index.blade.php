                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <ul class="header-dropdown m-r--5" style="margin-top: 10px;">
                            <a href="{{route('faq.create')}}" class="btn btn-primary fa fa-plus"> Add FAQ</a>
                        </ul>
                    </div>
                    @if(session('success'))
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="faqDelete({{$item->id}})" style="color: #fff; cursor:pointer;" class="btn btn-danger"><span class="fa fa-trash-alt"></span> Delete</a>
